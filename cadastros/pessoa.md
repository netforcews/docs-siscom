...
**Tipo** | Informe o tipo, física ou jurídica. Por padrão, este campo é obrigatório.  Opções: Física, Jurídica.
...
## Configurações
![pessoa.configuracoes](https://raw.githubusercontent.com/netforcews/docs-siscom/master/cadastros/imagens/pessoa.configuracoes.png)
...
**Representante** | Selecione se a pessoa é um representante.
**Banco** | Selecione se a pessoa é um banco.
**Outros** | Selecione se a pessoa é outros.
<br>

## Perfil
![pessoa.perfil](https://raw.githubusercontent.com/netforcews/docs-siscom/master/cadastros/imagens/pessoa.perfil.png)
